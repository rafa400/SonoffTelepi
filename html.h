      ...
      <table class="pure-table pure-table-bordered">
          ...
          <tbody>
              <tr style="display: table-row;">
                ...
                <td><input type="text"  name="ext1IP" placeholder="0.0.0.0" value="%1c" pattern="(^$|^([0-9]{1,3}\.){3}[0-9]{1,3}$)"></td>
                <td>
              ...
              <tr  style="display: table-row;">
                ...
                <td><input type="text"  name="ext2IP" placeholder="0.0.0.0" value="%2c" pattern="^$|^([0-9]{1,3}\.){3}[0-9]{1,3}$"></td>
                <td>
              ...
              <tr style="display: table-row;">
                ...
                <td><input type="text"  name="ext3IP" placeholder="0.0.0.0" value="%3c" pattern="^$|^([0-9]{1,3}\.){3}[0-9]{1,3}$"></td>
                <td>
              ...
              <tr>
                ...
                <td><input type="text"  name="ext4IP" placeholder="0.0.0.0" value="%4c" pattern="^$|^([0-9]{1,3}\.){3}[0-9]{1,3}$"></td>
                <td>
